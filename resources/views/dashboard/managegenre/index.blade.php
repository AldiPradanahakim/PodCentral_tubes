    <x-layout>
        ...
        <aside class="w-64 bg-black flex flex-col h-screen">
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-700 mb-4">Manage Genre</h2>
                @if(session('success'))
                        ...
                        <thead class="bg-indigo-600 text-white">
                            ...
                            <tbody>
                                    ...
                                    <tr class="border-t border-gray-200">
                                        ...
                                        <td class="px-4 py-2">{{ $genre->nama }}</td>
                                        <td class="px-4 py-2">
                                            <div class="flex items-center justify-start space-x-2">
                                                <button type="button" data-modal-toggle="edit-genre-modal-{{ $genre->id }}"
                                                        class="text-blue-500 hover:underline">Edit</button>
                                                <button type="button"
                                                        onclick="showDeleteModal('{{ route('dashboard.managegenre.destroy', $genre->id) }}')"
                                                        class="text-red-500 hover:underline">Delete</button>
                                            </div>
                                        </td>
                                    </tr>
                                        <!-- Edit Modal -->
                                <div id="edit-genre-modal-{{ $genre->id }}" tabindex="-1" aria-hidden="true"
                                        ...
                                        <div
                                            ...
                                            <button type="button"
                                                class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                                    data-modal-hide="edit-genre-modal-{{ $genre->id }}">
                                            ...
                                            <div class="p-6 space-y-6">
                                                <form
                                                    action="{{ route('dashboard.managegenre.update', $genre->id) }}"
                                                    method="POST">
                                                @csrf
                                                @method('PUT')
                                                    <div class="mb-4">
                ...
                <div class="fixed bottom-6 right-6">
                    <a href="{{ route('dashboard.managegenre.create') }}"
        ...
        <!-- Delete Modal -->
            ...
            <div class="bg-white p-6 rounded shadow-lg">
                <p class="mb-4">Are you sure you want to delete this genre?</p>
