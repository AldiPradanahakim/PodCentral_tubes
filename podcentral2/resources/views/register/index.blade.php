            ...
            <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <form>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-2">
                            <input type="text" name="name" id="name" required class="block w-full rounded-md bg-white px-4 py-3 text-base text-white outline-none shadow-sm focus:ring-2 focus:ring-indigo-500 sm:text-sm">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-2">
                            <input type="email" name="email" id="email" required autocomplete="email" class="block w-full rounded-md bg-white px-4 py-3 text-base text-white outline-none shadow-sm focus:ring-2 focus:ring-indigo-500 sm:text-sm">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-2">
                            <input type="password" name="password" id="password" required autocomplete="new-password" class="block w-full rounded-md bg-white px-4 py-3 text-base text-white outline-none shadow-sm focus:ring-2 focus:ring-indigo-500 sm:text-sm">
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-2">
                            <input type="password" name="password_confirmation" id="password_confirmation" required autocomplete="new-password" class="block w-full rounded-md bg-white px-4 py-3 text-base text-white outline-none shadow-sm focus:ring-2 focus:ring-indigo-500 sm:text-sm">
                        </div>
                    </div>
